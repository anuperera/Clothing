...
class CostLow : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cost_low)
        ...
        val na = findViewById<ImageButton>(R.id.imageButton)
        // set on-click listener
        ...
        val nil = findViewById<ImageButton>(R.id.imageButton5)
        // set on-click listener
        ...
        val mimosa = findViewById<ImageButton>(R.id.imageButton6)
        // set on-click listener
        ...
        val op = findViewById<ImageButton>(R.id.imageButton3)
        // set on-click listener
        ...
        val mim = findViewById<ImageButton>(R.id.imageButton4)
        // set on-click listener
