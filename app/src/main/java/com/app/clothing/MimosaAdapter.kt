...
class MimosaAdapter: RecyclerView.Adapter<MimosaAdapter.ViewHolder>() {
    ...
    private val LadyImage = intArrayOf(R.drawable.lady_10, R.drawable.lady_6, R.drawable.lady_4,
        R.drawable.lady_9, R.drawable.lady_1, R.drawable.lady_2, R.drawable.lady_3,
        R.drawable.lady_8, R.drawable.lady_7, R.drawable.lady_5)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MimosaAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.card2, parent, false)
        return ViewHolder(v)
    }

    override fun onBindViewHolder(holder: MimosaAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            itemTitle = itemView.findViewById(R.id.item_title1)
            itemDetail = itemView.findViewById(R.id.item_detail1)
            itemPrice = itemView.findViewById(R.id.item_price1)
            addBtn = itemView.findViewById(R.id.add_Btn1)
